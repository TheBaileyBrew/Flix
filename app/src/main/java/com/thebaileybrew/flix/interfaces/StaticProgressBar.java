...
/**
 * Code modified from CircleProgress Library
 * Copyright 2014 Bruce Lee -- bruceinpeking#gmail.com
 */
...
public class StaticProgressBar extends View {
    ...
    public StaticProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = displayMetricsUtils.screenToPixel(getResources(), 18);
        min_size = (int) displayMetricsUtils.displayToPixel(getResources(), 100);
        default_text_size = displayMetricsUtils.screenToPixel(getResources(), 40);
        default_suffix_text_size = displayMetricsUtils.screenToPixel(getResources(), 15);
        default_suffix_padding = displayMetricsUtils.displayToPixel(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = displayMetricsUtils.screenToPixel(getResources(), 10);
        default_stroke_width = displayMetricsUtils.displayToPixel(getResources(), 4);
